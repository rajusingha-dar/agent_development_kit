...
# from utils import add_user_query_to_history, call_agent_asyncs
...
async def main_async():
    ...
    # ===== PART 3: Session Creation =====
    # Create a new session with initial state (await the async method)
    ...
    while True:
        ...
        # Update interaction history with the user's query (await the async method)
    ...
    # ===== PART 6: State Examination =====
    # Show final session state (await the async method)
